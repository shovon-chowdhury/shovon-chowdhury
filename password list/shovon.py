...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  shovon.py! \033[27m                # Common")
    print("      \                     # User")
    print("       \   \033[1;31m,__,\033[1;m             # Passwords")
    print("        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # Profiler")
    print("           \033[1;31m(__)    )\ \033[1;m  ")
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ shovon | isanahmadshovon@gmail.com ]"
    )
    print(28 * " " + "[ shovon | isanahmadshovon@gmail.com]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ shovon.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Hacked up by j0rgan - isanahmadshovon@gmail.com")
...
def improve_dictionary(file_to_open):
    ...
    print_to_file(file_to_open + ".shovon.txt", unique_list_finished)
...
def generate_wordlist_from_profile(profile):
    ...
    if profile["leetmode"] == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in shovon.cfg too...
...
# the main function
def main():
    """Command-line interface to the shovon utility"""
